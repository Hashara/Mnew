...
//params
    ...
    public static function hasAccess($controller_name,$action_name='index')
    {
        ...
        // // }
        // $Acount=strpos(currentUser()->username, "ADMIN")
        // $Apassword=strpos(currentUser()->password, "ADMIN");
        // $Ccount=strpos(currentUser()->username, "COMPANY")
        // $Cpassword=strpos(currentUser()->password, "COY");

    	// if($currentUser()->username contains "ADMIN" && currentUser()->password contains "ADMIN")
        ...
        // if(strpos(currentUser()->username, 'COY')!=false  && strpos(currentUser()->password, 'COY')!=false)
        {
            // currentUser()->usertype="Company";
            $current_user_acls[]="Company";
            foreach(currentUser()-> acls() as $a)
            {
                // dnd($current_user_acls);
                $current_user_acls[]=$a;
        ...
        // elseif(strpos(currentUser()->username, "ADMIN")!=false && strpos(currentUser()->password, "ADMIN")!=false)
        {
        ...
        // elseif(strpos(currentUser()->username, "GVN")!=false && strpos(currentUser()->password, "GVN")!=false)
        elseif(currentUser()->usertype=="Government")
        {
            $current_user_acls[]="Government";
            // currentUser()->usertype="Admin";
            foreach(currentUser()-> acls() as $a)
            {
                // dnd($current_user_acls);
